...
admin.site.register(school_details_atl_incharge)
admin.site.register(schoolatlincharges)
admin.site.register(aes)
admin.site.register(teachernominatedforatl)
admin.site.register(student_login_detail)
admin.site.register(Atl_login_detail)
admin.site.register(Questions)
admin.site.register(table)
admin.site.register(Answer)
admin.site.register(Tracker)
admin.site.register(Response)
admin.site.register(AI_Questions)
admin.site.register(venreg1)
